                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="patient-login-tab" data-toggle="tab" href="#patient-login" role="tab" aria-controls="patient-login" aria-selected="false">Patient Login</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="#patient-login" data-toggle="tab">Already have an account?</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-check">
                                            <input type="checkbox" class="form-check-input" id="remember_doctor" name="remember_me">
                                            <label class="form-check-label" for="remember_doctor">Remember Me</label>
                                        </div>
                            ...
                            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="admin-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-check">
                                            <input type="checkbox" class="form-check-input" id="remember_admin" name="remember_me">
                            ...
                            <div class="tab-pane fade show" id="patient-login" role="tabpanel" aria-labelledby="patient-login-tab">
                                ...
                                <form method="post" action="func.php">
                                    <div class="row register-form">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="remember_patient" name="remember_me">
                                                <label class="form-check-label" for="remember_patient">Remember Me</label>
                                            </div>
                                            <a href="#home" data-toggle="tab">Don't have an account? Register here.</a>
                                        </div>
                                        <div class="col-md-6">
