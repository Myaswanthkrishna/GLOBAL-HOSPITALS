...
-- SQL PATCHES AND FIXES (MERGED FROM ALL .sql FILES)

-- 1. Make email column unique in patreg table
ALTER TABLE patreg ADD UNIQUE (email);

-- 2. Ensure the password column is correct length for hashes
ALTER TABLE `patreg` MODIFY `password` VARCHAR(255) NOT NULL;

-- 3. Remove duplicate emails, keeping only the first entry for each email (optional)
-- DELETE t1 FROM patreg t1
-- INNER JOIN patreg t2 
-- WHERE t1.pid > t2.pid AND t1.email = t2.email;

-- 4. Remove all existing patients (if you want a clean slate; optional)
-- DELETE FROM `patreg`;

-- 5. Insert the user shiva123@gmail.com with a hashed password
INSERT INTO `patreg` (`pid`, `fname`, `lname`, `gender`, `email`, `contact`, `password`, `cpassword`) VALUES
(1, 'Shiva', 'Test', 'Male', 'shiva123@gmail.com', '9999999999', '$2y$12$uL5kb2QkVEd7QHxbr2aKr.VT9yqSq2eKYiD7epcSnbtNaC/4xXX3W', 'shiva12345');

-- 6. To update password for existing user (if needed)
-- UPDATE `patreg` SET `password` = '$2y$12$uL5kb2QkVEd7QHxbr2aKr.VT9yqSq2eKYiD7epcSnbtNaC/4xXX3W' WHERE `email` = 'shiva123@gmail.com';

-- 7. To verify users
SELECT `pid`, `fname`, `email`, `password` FROM `patreg` WHERE `email` LIKE '%shiva%';

-- 8. Update password for shiva123@gmail.com (legacy patch)
UPDATE patreg SET password = '$2y$12$uL5kb2QkVEd7QHxbr2aKr.VT9yqSq2eKYiD7epcSnbtNaC/4xXX3W' WHERE email = 'shiva123@gmail.com';
